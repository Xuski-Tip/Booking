                        ...
                        >
                            {Object.keys(this.state.news).map((key) => {
                                return (
                                    <div
                                        key={key}
                                        className="post-item border shadow"
                                    >
                                        <div className="post-item-wrap">
                                            ...
                                            <div className="post-item-description">
                                                ...
                                                <h2>
                                                    <a href="http://localhost:3000/">
                                                        Standard post with a
                                                        single image
                                                    </a>
                                                </h2>
                                                <p>
                                                    Curabitur pulvinar euismod
                                                    ante, ac sagittis ante
                                                    posuere ac. Vivamus luctus
                                                    commodo dolor porta feugiat.
                                                    Fusce at velit id ligula
                                                    pharetra laoreet.
                                                </p>
