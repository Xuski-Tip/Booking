                ...
                <div className="row">
                    <div className="col-12 col-lg-8 font2">
                        ...
                        <div className="d-flex align-items-center mt-3">
                            ...
                            <div className="">
                                <p className="mb-0">{t("tartib.tartib2")}</p>
                                <p className="mb-0 ml-3">{" *  "}{t("tartib.tartib3")}</p>
                                <p className="mb-0 ml-3">{" *  "}{t("tartib.tartib4")}</p>
                                <p className="mb-0 ml-3">{" *  "}{t("tartib.tartib11")}</p>
                            </div>
                        </div>
                        <div className="d-flex align-items-center mt-3">
                            <h1 className="text-grey mr-4">02</h1>
                            <p className="">{t("tartib.tartib5")}</p>
                        </div>
                        <div className="d-flex align-items-center mt-3">
                            <h1 className="text-grey mr-4">03</h1>
                            <p className="mb-4">{t("tartib.tartib6")}</p>
                        </div>
                        <div className="d-flex align-items-center mt-3">
                            <h1 className="text-grey mr-4">04</h1>
                            <p className="">{t("tartib.tartib7")}</p>
                        </div>
                        <div className="d-flex align-items-center mt-3">
                            <h1 className="text-grey mr-4">05</h1>
                            <p className="mb-4">{t("tartib.tartib8")}</p>
                        </div>
                        <div className="d-flex align-items-center mt-3">
                            <h1 className="text-grey mr-4">06</h1>
                            <p className="">{t("tartib.tartib9")}</p>
                        </div>
                    </div>
                </div>
            </div>
